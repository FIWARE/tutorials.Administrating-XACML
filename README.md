...
* Can access the **Store** data from 9 a.m. to 5 p.m.
...
The context data for the **Store** is held in the Context Broker and therefore is secured behind the **PEP Proxy**.
