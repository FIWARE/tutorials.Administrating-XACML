...
for store detectives and another for management users. A series of permissions have been set up for the supermarket application, the following rules are applied:

#### Security Staff

* Can unlock the door at any time
* Can ring the alarm bell before 9 a.m. or after 5 p.m.
* Can access the **Store** data before 9 a.m. or after 5 p.m.
...
* Can access the **Store** data from 9 a.m. to 5 p.m. daily
* Can ring the alarm bell between 9 a.m. and 5 p.m.

As you can see some of the rules now have a time element to them and are no longer simple VERB-Resource rules.



> **Note** within the **Keyrock**, only three resources have been secured using advanced authorization rules (level 3)
>
